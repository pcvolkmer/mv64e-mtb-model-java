...
public class MtbStudyEnrollmentRecommendation {
  ...
  public MtbStudyEnrollmentRecommendation medication(@Nullable Set<AtcUnregisteredMedicationCoding> medication) {
    this.medication = medication;
    return this;
  }

  public MtbStudyEnrollmentRecommendation addMedicationItem(AtcUnregisteredMedicationCoding medicationItem) {
  ...
  public MtbStudyEnrollmentRecommendation supportingVariants(@Nullable List<GeneAlterationReference> supportingVariants) {
    this.supportingVariants = supportingVariants;
    return this;
  }

  public MtbStudyEnrollmentRecommendation addSupportingVariantsItem(GeneAlterationReference supportingVariantsItem) {
  ...
  public MtbStudyEnrollmentRecommendation supportingFindings(@Nullable List<Reference> supportingFindings) {
    this.supportingFindings = supportingFindings;
    return this;
  }

  public MtbStudyEnrollmentRecommendation addSupportingFindingsItem(Reference supportingFindingsItem) {
  ...
  public MtbStudyEnrollmentRecommendation levelOfEvidence(@Nullable LevelOfEvidence levelOfEvidence) {
  ...
  public boolean equals(Object o) {
    ...
    MtbStudyEnrollmentRecommendation mtbStudyEnrollmentRecommendation = (MtbStudyEnrollmentRecommendation) o;
    return Objects.equals(this.priority, mtbStudyEnrollmentRecommendation.priority) &&
        ...
        Objects.equals(this.supportingVariants, mtbStudyEnrollmentRecommendation.supportingVariants) &&
        ...
        Objects.equals(this.supportingFindings, mtbStudyEnrollmentRecommendation.supportingFindings) &&
  ...
  @Override
  public int hashCode() {
    return Objects.hash(priority, medication, supportingVariants, reason, patient, supportingFindings, levelOfEvidence, id, issuedOn, study);
  }
  ...
  private String toIndentedString(Object o) {
    ...
    public MtbStudyEnrollmentRecommendation.Builder priority(RecommendationPriorityCoding priority) {
      this.instance.priority = priority;
      return this;
    }
    public MtbStudyEnrollmentRecommendation.Builder medication(Set<AtcUnregisteredMedicationCoding> medication) {
      this.instance.medication = medication;
      return this;
    }
    public MtbStudyEnrollmentRecommendation.Builder supportingVariants(List<GeneAlterationReference> supportingVariants) {
    ...
    public MtbStudyEnrollmentRecommendation.Builder supportingFindings(List<Reference> supportingFindings) {
      this.instance.supportingFindings = supportingFindings;
      return this;
    }
    public MtbStudyEnrollmentRecommendation.Builder levelOfEvidence(LevelOfEvidence levelOfEvidence) {
